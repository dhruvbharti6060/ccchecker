...
<div class="card col-sm-8">
  <h5 class="card-body h6">Braintree</h5>
  <div class="card-body">
    <center><span>Braintree</span></center>
<div class="md-form">
	<div class="col-md-12">
  <textarea type="text" style="text-align: center;" id="lista" class="md-textarea form-control" rows="2"></textarea>
  <label for="lista">CC HERE</label>
</div>
</div>
<center>
 <button class="btn btn-primary" style="width: 200px; outline: none;" id="testar" onclick="enviar()" >TEST</button>
...
<footer >
    ...
    <div class="footer-copyright text-center py-3">Edited by WOLFGANG(using braintree):
      <a href="https://discordapp.com/"> FUCK THIS CHECKER</a>
    </div>
